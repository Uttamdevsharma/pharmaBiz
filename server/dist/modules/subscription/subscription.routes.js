...
router.post("/check-expiry-reminders", authenticate_1.authenticate, (0, authorize_1.authorize)(["SUPER_ADMIN", "CTO", "PROJECT_MANAGER"]), subscription_controller_1.SubscriptionController.triggerExpiryCheck);
