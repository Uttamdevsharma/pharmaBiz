...
router.post("/accounts/deposit", (0, requirePermission_1.requirePermission)("accounts.manage"), (0, validate_1.validateRequest)({ body: accounting_validation_1.depositFundsSchema }), accounting_controller_1.AccountingController.depositFunds);
...
// ==========================================
router.get("/recurring-expenses", (0, requirePermission_1.requirePermission)("expenses.list"), accounting_controller_1.AccountingController.listRecurringExpenses);
router.post("/recurring-expenses", (0, requirePermission_1.requirePermission)("expenses.list"), (0, validate_1.validateRequest)({ body: accounting_validation_1.createRecurringExpenseSchema }), accounting_controller_1.AccountingController.createRecurringExpense);
router.put("/recurring-expenses/:id", (0, requirePermission_1.requirePermission)("expenses.list"), (0, validate_1.validateRequest)({ body: accounting_validation_1.updateRecurringExpenseSchema }), accounting_controller_1.AccountingController.updateRecurringExpense);
router.delete("/recurring-expenses/:id", (0, requirePermission_1.requirePermission)("expenses.list"), accounting_controller_1.AccountingController.deleteRecurringExpense);
// ==========================================
...
// ==========================================
router.get("/salaries/employees", (0, requirePermission_1.requirePermission)("employee.view"), accounting_controller_1.AccountingController.listBranchStaffSalaries);
router.post("/salaries/config", (0, requirePermission_1.requirePermission)("salary.manage"), (0, validate_1.validateRequest)({ body: accounting_validation_1.setSalaryConfigSchema }), accounting_controller_1.AccountingController.setSalaryConfig);
router.post("/salaries/disburse", (0, requirePermission_1.requirePermission)("salary.manage"), (0, validate_1.validateRequest)({ body: accounting_validation_1.disburseSalarySchema }), accounting_controller_1.AccountingController.disburseSalary);
router.get("/salaries/branch-history", (0, requirePermission_1.requirePermission)("salary.history"), accounting_controller_1.AccountingController.getBranchSalaryHistory);
router.get("/salaries/history/:userId", (0, requirePermission_1.requirePermission)("salary.history"), accounting_controller_1.AccountingController.getEmployeeSalaryHistory);
