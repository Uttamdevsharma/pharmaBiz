...
exports.createProductSchema = zod_1.z.object({
    ...
    qtyPerLevel2: zod_1.z.number().int().positive().optional().nullable(),
    qtyPerLevel3: zod_1.z.number().int().positive().optional().nullable(),
    qtyPerLevel4: zod_1.z.number().int().positive().optional().nullable(),
