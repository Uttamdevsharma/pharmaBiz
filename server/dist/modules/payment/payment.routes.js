...
router.post("/initiate", authenticate_1.optionalAuthenticate, (0, validate_1.validateRequest)({ body: payment_validation_1.initiatePaymentSchema }), payment_controller_1.PaymentController.initiate);
