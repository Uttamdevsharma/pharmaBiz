...
export class EmailService {
   ...
   */
  static async sendOtpEmail(payload: OtpEmailPayload): Promise<{ success: boolean; messageId?: string; error?: string }> {
   ...
   */
  static async sendApprovalEmail(payload: ApprovalEmailPayload): Promise<{ success: boolean; messageId?: string; error?: string }> {
   ...
   */
  static async sendRejectionEmail(payload: RejectionEmailPayload): Promise<{ success: boolean; messageId?: string; error?: string }> {
